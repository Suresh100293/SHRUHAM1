...
namespace TFATERPWebApplication.Reports {
    ...
    public class RMani_Sales_Order_Ahd_IGST : ReportClass {
        
        public RMani_Sales_Order_Ahd_IGST() {
        }
        
        public override string ResourceName {
            get {
                return "RMani_Sales_Order_Ahd_IGST.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TFATERPWebApplication.Reports.RMani_Sales_Order_Ahd_IGST.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRMani_Sales_Order_Ahd_IGST : Component, ICachedReport {
        
        public CachedRMani_Sales_Order_Ahd_IGST() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RMani_Sales_Order_Ahd_IGST rpt = new RMani_Sales_Order_Ahd_IGST();
            rpt.Site = this.Site;
            return rpt;
        }
