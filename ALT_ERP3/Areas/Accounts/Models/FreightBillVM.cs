...
namespace ALT_ERP3.Areas.Accounts.Models
{
    public class FreightBillVM
    {
        ...
        public List<FreightBillVM> NewItemList { get; set; }
        public List<FreightBillVM> PickUpList { get; set; }

        public List<FreightBillVM> LedgerPostList { get; set; }
        ...
        public List<FreightBillVM> DelyScheList { get; set; }
        ...
        public List<FreightBillVM> Charges { get; set; }
        ...
        public List<FreightBillVM> DocumentList { get; set; }
        ...
        public List<FreightBillVM> LRChargeList { get; set; }
        ...
        public List<string> ChargeCodeList { get; set; }
