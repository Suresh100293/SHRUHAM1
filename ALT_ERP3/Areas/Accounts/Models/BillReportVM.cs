...
namespace ALT_ERP3.Areas.Accounts.Models
{
    public class BillReportVM
    {
        ...
        public string BillTypeL { get; set; }
        ...
        public bool PaymentReceivedDetails { get; set; }
        public bool PaymentReceDetailsChargesReq { get; set; }
        public bool BillSubMissionDetails { get; set; }
