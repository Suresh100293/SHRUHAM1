...
namespace ALT_ERP3.Areas.Accounts.Models
{
    public class CreditPurchaseVM
    {
        ...
        public List<CreditPurchaseVM> ValueList { get; set; }
        ...
        public IList<CreditPurchaseVM> Selectedleger { get; set; }
        ...
        public List<CreditPurchaseVM> LRDetailList { get; set; }
        public IList<CreditPurchaseVM> OSAdjList2 { get; set; }
        ...
        public IList<CreditPurchaseVM> costgroup1 { get; set; }
        public IList<CreditPurchaseVM> costcentre1 { get; set; }

        public IList<CreditPurchaseVM> CCList { get; set; }
        ...
        public List<CreditPurchaseVM> NewReferenceList { get; set; }
        public List<CreditPurchaseVM> ReferencePickUpList { get; set; }
        ...
        public List<CreditPurchaseVM> DocumentList { get; set; }
        ...
        public string VendorACN { get; set; }

        public decimal TotDebit { get; set; }

        public decimal TotCredit { get; set; }

        public List<CreditPurchaseVM> LedgerPostList { get; set; }
        ...
        public List<CreditPurchaseVM> FMDetailList { get; set; }
        public List<CreditPurchaseVM> ConsignmentExplist { get; set; }
        ...
        public List<CreditPurchaseVM> TyreStockList { get; set; }
        ...
        public bool CheckMode { get; internal set; }
