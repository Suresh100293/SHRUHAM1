...
namespace ALT_ERP3
{
    public class DebtorReceiptVM
    {
        ...
        public List<DebtorReceiptVM> SelectedLedger { get; set; }
        ...
        public List<DebtorReceiptVM> ChargesList { get; set; }
        ...
        public List<DebtorReceiptVM> PickupList { get; set; }
        ...
        public List<DebtorReceiptVM> LedgerPostList { get; set; }
