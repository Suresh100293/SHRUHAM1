...
{
    public class OtherTransactionJVController : BaseController
    {
        ...
        public ActionResult GetCashBankList(string term)
        {
            if (term == "" || term == null)
            {
                var result = ctxTFAT.Master.Where(x => (x.AppBranch.Contains(mbranchcode) || x.AppBranch == "All") && x.Hide == false).Select(c => new { c.Code, c.Name }).Distinct().ToList();
                return Json(result, JsonRequestBehavior.AllowGet);

            }
            else
            {
                var result = ctxTFAT.Master.Where(x => (x.AppBranch.Contains(mbranchcode) || x.AppBranch == "All") && x.Name.Contains(term) && x.Hide == false).Select(m => new { m.Code, m.Name }).Distinct().ToList();
                return Json(result, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult GetAccountList(string term)
        {
            ...
            {
                var result = ctxTFAT.Master.Where(m => (m.AppBranch.Contains(mbranchcode) || m.AppBranch == "All") && m.Hide == false).Select(m => new
                {
                    m.Code,
                    m.Name
                }).OrderBy(n => n.Name).ToList();

                result = result.Where(x => x.Code != value).OrderBy(n => n.Name).ToList();
                return Json(result, JsonRequestBehavior.AllowGet);
            }
            else
            {
                var result = ctxTFAT.Master.Where(x => x.Name.Contains(value1) && (x.AppBranch.Contains(mbranchcode) || x.AppBranch == "All") && x.Hide == false).Select(m => new
                {
                    m.Code,
                    m.Name
                }).OrderBy(n => n.Name).ToList();
        ...
        public ActionResult Index(OtherTransactModel Model)
        {
            ...
            var Setup = ctxTFAT.OtherTransactSetupJV.FirstOrDefault();
            if (Setup == null)
            {
                Setup = new OtherTransactSetupJV();
            }
            //var OtherBillQuery = @"select isnull(BillBoth,0) as BillBoth,BillAuto,CCAmtMatch,BackDays,ShowLedgerPost,BackDated,DuplExpLRFMConfirm,NoDuplExpLRFM,ForwardDated,ForwardDays,ShowDocSerial,AllowZeroAmt,AutoRemark,NoDuplExpDt,DuplExpDtConfirm from OtherTransactSetupJV";
            ...
            if (Model.Mode == "Add")
            {
                ...
                Session["JVothertrxlist"] = null;
                Session["JVTempOthCashBkAttach"] = null;
            ...
            else
            {
                ...
                Session.Add("JVothertrxlist", objledgerdetail);
            ...
            var list = ctxTFAT.DocFormats.Where(x => x.Type == "COT00").Select(x => x).ToList();
            if (list != null)
            {
        ...
        public ActionResult AddCashLedger(OtherTransactModel Model)
        {
            ...
            if (Model.RelatedTo == "000100345" || Model.Code == "000100345")
            {
                ...
                if (Model.SessionFlag == "Add")
                {
                    ...
                    if (Session["JVothertrxlist"] != null)
                    {
                        objledgerdetail1 = (List<OtherTransactModel>)Session["JVothertrxlist"];
                    }
            ...
            if (Model.SessionFlag == "Add")
            {
                ...
                if (Session["JVothertrxlist"] != null)
                {
                    objledgerdetail = (List<OtherTransactModel>)Session["JVothertrxlist"];
                }
            ...
            {
                var objledgerdetail = (List<OtherTransactModel>)Session["JVothertrxlist"];
        ...
        {
            var Status = "Sucess";
            var result = (List<OtherTransactModel>)Session["JVothertrxlist"];
            ...
            Session.Add("JVothertrxlist", result2);
        ...
        public ActionResult GetPostingNew(OtherTransactModel Model)
        {
            ...
            {
                var resultw = ctxTFAT.DocTypes.Where(x => x.Code == "COT00").Select(x => x).FirstOrDefault();
        ...
        public void DeUpdate(OtherTransactModel Model)
        {
            ...
            var result1 = (List<OtherTransactModel>)Session["JVothertrxlist"];
            foreach (var item in result1)
            {
            ...
            if (Model.Mode == "Delete")
            {
                ...
                result = (List<OtherTransactModel>)Session["JVothertrxlist"];
                foreach (var item in result)
                {
            ...
            using (var transaction = ctxTFAT.Database.BeginTransaction(System.Data.IsolationLevel.Unspecified))
            {
                try
                {
                    ...
                    if (Model.Mode == "Add")
                    {
                        ...
                        {
                            var result1 = ctxTFAT.DocTypes.Where(x => x.Code == "COT00").Select(x => x).FirstOrDefault();
                    ...
                    TfatUserAuditHeader authorisation = ctxTFAT.TfatUserAuditHeader.Where(x => x.Type == "COT00").FirstOrDefault();
                    ...
                    List<OtherTransactModel> result = new List<OtherTransactModel>();
                    result = (List<OtherTransactModel>)Session["JVothertrxlist"];
                    OtherTransactSetupJV setup = ctxTFAT.OtherTransactSetupJV.FirstOrDefault();
                    if (setup == null)
                    {
                        setup = new OtherTransactSetupJV();
                    }
                    if (Model.Mode == "Add" || Model.Mode == "Edit")
                    {
                        ...
                        UpdateAuditTrail(Model.Branch, Model.Mode, Model.Header, Model.ParentKey, ConvertDDMMYYTOYYMMDD(Model.DocuDate), Model.Amt, Model.BankCashCode, "Save Journal Vouchers With Cost", "A");
        ...
        public ActionResult DeleteData(OtherTransactModel Model)
        {
            ...
            var SetupTyreStockDelete = ctxTFAT.OtherTransactSetupJV.Select(x => x.TyreStockDelete).FirstOrDefault();
            ...
            using (var transaction = ctxTFAT.Database.BeginTransaction(System.Data.IsolationLevel.Unspecified))
            {
                try
                {
                    ...
                    transaction.Commit();
                    transaction.Dispose();
                    UpdateAuditTrail(Model.Branch, "Delete", Model.Header, Model.ParentKey, ConvertDDMMYYTOYYMMDD(Model.DocuDate), Model.Amt, Model.BankCashCode, "Delete Journal Vouchers With Cost", "A");
        ...
        public void SaveAttachment(AttachmentVM Model)
        {
            ...
            if (DocList != null && DocList.Count != 0)
            {
                ...
                foreach (var item in DocList.ToList())
                {
                    ...
                    att.Type = String.IsNullOrEmpty(item.Type) == true ? "COT00" : item.Type;
