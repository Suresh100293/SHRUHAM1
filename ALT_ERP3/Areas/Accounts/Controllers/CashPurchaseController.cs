...
{
    public class CashPurchaseController : BaseController
    {
        ...
        public ActionResult GetOnlyCreditorsList(string term)
        {
            if (term == "" || term == null)
            {
        ...
        public ActionResult Index(CreditPurchaseVM Model)
        {
            ...
            {
                Model.BillBoth = true;
                Model.BillAuto = false;
                Model.CCAmtMatch = false;
                ...
                Model.DuplExpLRFMConfirm = true;
                Model.NoDuplExpLRFM = false;
                ...
                Model.ShowDocSerial = false;
                Model.AllowZeroAmt = true;
                Model.AllowAutoRemark = true;
                Model.NoDuplExpDt = false;
                Model.DuplExpDtConfirm = true;
            ...
            if (Model.Mode == "Add")
            {
                ...
                Model.MainType = result.MainType;
                Model.SubType = result.SubType;
                Model.BankCashCode = ctxTFAT.Purchase.Where(x => x.Branch == mbranchcode && x.Type=="CPH00").OrderByDescending(x => x.RECORDKEY).Select(x => x.Account).FirstOrDefault();
            ...
            else
            {
                ...
                Session.Add("CPHLothertrxlist", objledgerdetail);
                ...
                if (!String.IsNullOrEmpty(IntoSingleLine))
                {
                    ...
                    //string connstring = GetConnectionString();
                    string mSQLQuery = "with Demo as( SELECT  value  FROM TripSheetMaster CROSS APPLY STRING_SPLIT(AdjustLedgerRef, '^') where len(AdjustLedgerRef)>5) select count(*) from Demo where Value in (" + IntoSingleLine + ")";
                ...
                Model.VendorAC = mobj1.VendorAC;
                Model.VendorACN =ctxTFAT.Master.Where(x=>x.Code== mobj1.VendorAC).Select(x=>x.Name).FirstOrDefault();
            ...
            var list = ctxTFAT.DocFormats.Where(x => x.Type == "CPH00").Select(x => x).ToList();
            if (list != null)
            {
        ...
        public ActionResult AddCashLedger(CreditPurchaseVM Model)
        {
            ...
            if (Model.RelatedTo == "000100345" || Model.Code == "000100345")
            {
                ...
                if (Model.SessionFlag == "Add")
                {
                    ...
                    if (Session["CPHLothertrxlist"] != null)
                    {
                        objledgerdetail1 = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];
                    }
            ...
            if (Model.SessionFlag == "Add")
            {
                ...
                if (Session["CPHLothertrxlist"] != null)
                {
                    objledgerdetail = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];
                }
                ...
                if (Model.AddOnList != null)
                {
                    ...
                    {
                        Model.Narr += "Accident Date: " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + ", Amount: " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault();
                    }
                    else if (Model.RelatedTo == "000100950" || Model.Code == "000100950")
                    {
                        Model.Narr += "Body Building Date: " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + ", Amount : " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault();
                    }
                    ...
                    {
                        Model.Narr += "Principal Amount Date: " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + ", Amount: " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault();
                    }
                    ...
                    {
                        Model.Narr += "Fitness:- Year : [ " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + " ] : [ " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100653" || Model.Code == "000100653")
                    {
                        Model.Narr += "Green Tax:- Year : [ " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + " ] : [ " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100811" || Model.Code == "000100811")
                    {
                        Model.Narr += "State Tax:- Year : [ " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + " ] : [ " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100781" || Model.Code == "000100781")
                    {
                        Model.Narr += "Permit 1 Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + " ] : [ " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100953" || Model.Code == "000100953")
                    {
                        Model.Narr += "Permit 5 Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + " ] : [ " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000101135" || Model.Code == "000101135")
                    {
                        Model.Narr += "TP(Transit Pass) Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + "] - [" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100788" || Model.Code == "000100788")
                    {
                        Model.Narr += "PT :- Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + "] - [" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100789" || Model.Code == "000100789")
                    {
                        Model.Narr += "PUC :- Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + "] - [" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100326" || Model.Code == "000100326")
                    {
                        Model.Narr += "Insurance :- Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + "] - [" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100951" || Model.Code == "000100951")
                    {
                        Model.Narr += "Loan :- Year: [" + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + "] - [" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + " ]";
                    }
                    else if (Model.RelatedTo == "000100346" || Model.Code == "000100346")
                    {
                        Model.Narr += "\nSpare Parts Repairs : " + " Receipt No : " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + ", Receipt Date : " + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault();
                    }
                    else if (Model.RelatedTo == "000100341" || Model.Code == "000100341")
                    {
                        Model.Narr += "Trip :- Start Date : " + Model.AddOnList.Where(x => x.Fld == "F001").Select(X => X.ApplCode).FirstOrDefault() + ",  End Date :" + Model.AddOnList.Where(x => x.Fld == "F002").Select(X => X.ApplCode).FirstOrDefault() + ", Days : " + Model.AddOnList.Where(x => x.Fld == "F003").Select(X => X.ApplCode).FirstOrDefault() + ", kms : " + Model.AddOnList.Where(x => x.Fld == "F004").Select(X => X.ApplCode).FirstOrDefault() + " - " + Model.AddOnList.Where(x => x.Fld == "F005").Select(X => X.ApplCode).FirstOrDefault();
                    }
                    else if (Model.RelatedTo == "000100345" || Model.Code == "000100345")
                    {
                ...
                var InvAmt = sumdebit + IGST + SGST + CGST;
            ...
            {
                var objledgerdetail = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];
        ...
        {
            var result = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];

            var result2 = result.Where(x => x.tempId != Model.tempId).Select(x => x).ToList();
            Session.Add("CPHLothertrxlist", result2);
        ...
        public ActionResult RelatedToDecide(CreditPurchaseVM Model)
        {
            ...
            if (UseHSN)
            {
                ...
                if (pstate == branchstate)
                {
                    var result = ctxTFAT.HSNRates.Where(x => x.Code == Masteraddress.HSNCode && x.EffDate <= EffectDate).OrderByDescending(x => x.EffDate).Select(x => new { IGSTRate = (decimal)0, SGSTRate = x.SGSTRate.Value, CGSTRate = x.CGSTRate.Value }).FirstOrDefault();
                ...
                {
                    var result = ctxTFAT.HSNRates.Where(x => x.Code == Masteraddress.HSNCode && x.EffDate <= EffectDate).OrderByDescending(x => x.EffDate).Select(x => new { IGSTRate = x.IGSTRate.Value, SGSTRate = (decimal)0, CGSTRate = (decimal)0 }).FirstOrDefault();
                    IGST = result == null ? 0 : result.IGSTRate;
                    SGST = result == null ? 0 : result.SGSTRate;
                    CGST = result == null ? 0 : result.CGSTRate;
                }
        ...
        public ActionResult GetTruckTypeWiseViewList(CreditPurchaseVM Model)
        {
            ...
            Model.RelatedToN = ctxTFAT.Master.Where(x => x.Code == Model.RelatedTo).Select(x => x.Name).FirstOrDefault();
            {
                ...
                else if (Model.Code == "000100345")
                {
                    ...
                    var mTyreTypes = ctxTFAT.ItemMaster.Where(x => x.BaseGr == Model.ProductGroupType).Select(x => new { x.Name, x.Code }).Distinct().ToList();
                    var mItemGroup = ctxTFAT.ItemGroups.Where(x => x.Hide == false).Select(x => new { x.Name, x.Code }).Distinct().ToList();
                    //truckaddonlist.Add(new AddOns()
                    //{
                    //    Fld = "F015",
                ...
                {
                    var mSparePart = ctxTFAT.ItemMaster.Where(x => x.BaseGr == Model.ProductGroupType).Select(x => new { x.Name, x.Code }).Distinct().ToList();
                    var mItemGroup = ctxTFAT.ItemGroups.Where(x => x.Hide == false).Select(x => new { x.Name, x.Code }).Distinct().ToList();
                    //truckaddonlist.Add(new AddOns()
                    //{
                    //    Fld = "F012",
        ...
        public List<AddOns> GetSessionEditItemWiseData(CreditPurchaseVM Model)
        {
            ...
            var mItem = ctxTFAT.ItemMaster.Where(x => x.BaseGr == mRelateData).Select(x => new { x.Name, x.Code }).Distinct().ToList();
            var mItemGroup = ctxTFAT.ItemGroups.Where(x => x.Hide == false).Select(x => new { x.Name, x.Code }).Distinct().ToList();
            truckaddonlist.Add(new AddOns()
            {
                Fld = "F001",
        ...
        public ActionResult GetPostingNew(CreditPurchaseVM Model)
        {
            ...
            {
                var result = ctxTFAT.DocTypes.Where(x => x.Code == "CPH00").Select(x => x).FirstOrDefault();
            ...
            if (ctxTFAT.PeriodLock.Where(x => x.Branch == mbranchcode && x.Type == "CPH00" && x.LockDate == Date).FirstOrDefault() != null)
            {
                return Json(new
                {
        ...
        public void DeUpdate(CreditPurchaseVM Model)
        {
            ...
            var result1 = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];
            foreach (var item in result1)
            {
            ...
            if (Model.Mode == "Delete")
            {
                ...
                result = (List<CreditPurchaseVM>)Session["CPHLothertrxlist"];
            ...
            using (var transaction = ctxTFAT.Database.BeginTransaction(System.Data.IsolationLevel.Unspecified))
            {
                try
                {
                    ...
                    if (Model.Mode == "Add")
                    {
                        ...
                        {
                            var result1 = ctxTFAT.DocTypes.Where(x => x.Code == "CPH00").Select(x => x).FirstOrDefault();
                        ...
                        AlertNoteMaster alertNoteMaster = ctxTFAT.AlertNoteMaster.Where(x => x.Type == "CPH00" && x.TypeCode.Trim() == Model.Srl.Trim() && x.Stop.Contains("CPH00")).FirstOrDefault();
                    ...
                    TfatUserAuditHeader authorisation = ctxTFAT.TfatUserAuditHeader.Where(x => x.Type == "CPH00").FirstOrDefault();
                                        ...
                                        if (li.RelatedTo == "000100345" || li.Code == "000100345")
                                        {
                                            ...
                                            else
                                            {
                                                if (Convert.ToInt32(reldt.Value3) > 0)
                                                {
                                                    ...
                                                    {
                                                        if (mDATE2.ToString().Trim() != "0001-01-01")
                                                        {
        ...
        public ActionResult DeleteData(CreditPurchaseVM Model)
        {
            ...
            using (var transaction = ctxTFAT.Database.BeginTransaction(System.Data.IsolationLevel.Unspecified))
            {
                try
                {
                    ...
                    if (mobj11 != null)
                    {
                        var RemoveAttach = ctxTFAT.Attachment.Where(x => x.Type == "CPH00" && x.Srl == mobj11.Srl.ToString()).ToList();
                        ...
                        var GetRemarkDocList = ctxTFAT.Narration.Where(x => x.Srl == mobj1.Srl.ToString() && x.Type == "CPH00").ToList();
        ...
        public void SaveAttachment(AttachmentVM Model)
        {
            ...
            if (DocList != null && DocList.Count != 0)
            {
                ...
                foreach (var item in DocList.ToList())
                {
                    ...
                    att.Type = String.IsNullOrEmpty(item.Type) == true ? "CPH00" : item.Type;
