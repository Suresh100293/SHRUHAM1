...
namespace ALT_ERP3.Areas.Vehicles.Models
{
    public class LocalChargesMaVM
    {
        ...
        public decimal LocalCharge { get; set; }
        public decimal LocalAdvance { get; set; }
        //public string LocalTime { get; set; }
        //public string LocalKM { get; set; }

        public List<LocalChargesMaVM> list { get; set; }
    ...
    public class CopyLocalChargesVM
    {
