...
{
    public class MonthlyBookingLRVM
    {
        ...
        public string DelBranchL { get; set; }
        public bool DelGeneral { get; set; }
        ...
        public string ChargeL { get; set; }



        public bool LRAmt { get; set; }
        public bool LRBillAmtF { get; set; }
