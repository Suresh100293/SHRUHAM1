...
namespace ALT_ERP3.Areas.Logistics.Controllers
{
    public class BranchStockReportController : BaseController
    {
        ...
        public ActionResult Index(LorryReceiptReportsVM Model)
        {
            ...
            BranchStockReportSetup branchStockReport = ctxTFAT.BranchStockReportSetup.FirstOrDefault();
            ...
            Model.FromBranchesOnly = PopulateBranchesOnly();
