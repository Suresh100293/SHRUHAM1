...
namespace ALT_ERP3.Areas.Logistics.Controllers
{
    public class TransactionMaintenanceGridController : BaseController
    {
        ...
        // GET: Logistics/TransactionMaintenanceGrid
        public ActionResult Index(GridOption Model)
        {
            ...
            {
                var userrightstrx2 = ctxTFAT.UserRightsTrx.Where(x => x.Code == muserid && x.Type == Model.Type).Select(x => x).FirstOrDefault();
                if (userrightstrx2 != null)
                {
                    Model.xAdd = userrightstrx2.xAdd;
                    Model.xEdit = userrightstrx2.xEdit;
                    Model.xDelete = userrightstrx2.xDelete;
                    Model.xView = userrightstrx2.xCess;
                }
            }
            return View(Model);
        }
        ...
        public ActionResult GetMultiPrint(GridOption Model)
        {
            ...
            Model.list = Grlist;
            var html = ViewHelper.RenderPartialView(this, "~/Areas/Transactions/Views/TransactionMaintenanceGrid/MultiPrint.cshtml", new GridOption() { list = Model.list });
        ...
        public ActionResult PrintSingleDocumentCrystal(GridOption Model)
        {
            ...
            //var absolutePath = HttpContext.Server.MapPath("~/Reports/" + Model.Format + ".rpt");
            ...
            try
            {
                ...
                //else
                //{
                //    return SendReportEMail(mstream, mSubType, Document, "", mFormatString + ".rpt");
                //}
            }
            catch
            {
