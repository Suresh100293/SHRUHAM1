...
{
    public class SMSReportsController : BaseController
    {
        ...
        public ActionResult GetGridData(Email_SMS_VM Model)
        {
            ...
            {
                ExecuteStoredProc("Drop Table ztmp_SMSReports");
                SqlConnection tfat_conx = new SqlConnection(GetConnectionString());
                SqlCommand cmd = new SqlCommand("SP_SMSReports", tfat_conx);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 120;

                cmd.Parameters.Add("@mUser", SqlDbType.VarChar).Value = Convert.ToString(TempData.Peek("SMSUser"));
